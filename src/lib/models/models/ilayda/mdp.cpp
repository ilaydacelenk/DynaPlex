...
namespace DynaPlex::Models {
	namespace ilayda /*keep this in line with id below and with namespace name in header*/
	{
		...
		void Register(DynaPlex::Registry& registry)
		{
			DynaPlex::Erasure::MDPRegistrar<MDP>::RegisterModel(
				/*=id though which the MDP will be retrievable*/ "ilayda",
				/*description*/ "Ilayda problem",
