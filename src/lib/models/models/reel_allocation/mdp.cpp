...
namespace DynaPlex::Models {
	namespace reel_allocation /*keep this in line with id below and with namespace name in header*/
	{
		...
		{
			DynaPlex::Erasure::MDPRegistrar<MDP>::RegisterModel("reel_allocation", "A simple example for material utilization with 2 active materials", registry);
