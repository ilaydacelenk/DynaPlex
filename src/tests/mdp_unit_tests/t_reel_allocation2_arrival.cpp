...
namespace DynaPlex::Tests {	
	TEST(reel_allocation2_arrival, mdp_config_2) {
		std::string model_name = "reel_allocation2_arrival"; // this should match the id and namespace name discussed earlier
		std::string config_name = "mdp_config_2.json";

		Tester tester{};
		tester.ExecuteTest(model_name, config_name);
	}
	TEST(reel_allocation2_arrival, mdp_config_5) {
		std::string model_name = "reel_allocation2_arrival"; // this should match the id and namespace name discussed earlier
	...
	TEST(reel_allocation2_arrival, mdp_config_2_policy) {
		std::string model_name = "reel_allocation2_arrival"; // this should match the id and namespace name discussed earlier
		std::string config_name = "mdp_config_2.json";
