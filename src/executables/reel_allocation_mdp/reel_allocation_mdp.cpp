...
#include "dynaplex/models/reel_allocation/mdp.h"
...
int main() {
    ...
    std::string model_name = "reel_allocation";
    ...
    try
    {
        ...
        auto path = dp.System().filepath("dcl", "reel_allocation_mdp", "reel_allocation_policy_gen" + std::to_string(num_gens));
